...
from utils.lib import get_jobs, get_number_of_jobs, set_job_filters
...
class SeekWebScraping:
    ...
    def get_jobs(self, additional_filters: list[str] = None):
        number_of_jobs = self.get_number_of_jobs()
        return get_jobs(self.driver, number_of_jobs, additional_filters)
